...
<body>
  ...
  include('koneksi.php');
  $no = $_GET['id'];
  $show = mysql_query("SELECT * FROM nilaikriteria WHERE no='$no'");
...
<!--       <a><img src="logo.png" alt="Image" height="62" width="55"></a> -->
    ...
    ?></select><br>
                      ...
                      <input name="isiKriteria" class="form-control" id="ex1" type="text" style="width:400px" value="<?php echo $data['isiKriteria']; ?>" required><br>
                      <label>Nilai</label>
                      <input name="nilai" class="form-control" id="ex1" type="text" style="width:400px" value="<?php echo $data['nilai']; ?>" required><br>
...
if(isset($_POST['tambah'])){
  ...
  $nilai    = $_POST['nilai'];
  $update = mysql_query("UPDATE nilaikriteria SET namaKriteria='$namaKriteria', isiKriteria='$isiKriteria', nilai='$nilai' WHERE no='$no'") or die(mysql_error());
