      ...
      <div class="row">
        ...
        <div class="col-sm-20">
          ...
          <div class="row">
            <div class="col-sm-20">
                  <div class="container">
                  <center><h1>Tambah Kriteria</h1><br><br>
                      <label>Kode</label>
                      <input name="kode" class="form-control" id="ex1" type="text" style="width:400px" required><br>
                      <label>Nama Kriteria</label>
                      <input name="namaKriteria" class="form-control" id="ex1" type="text" style="width:400px" required><br>
                      <label>Atribut</label>
                      <input name="atribut" class="form-control" id="ex1" type="text" style="width:400px" required><br>
...
if(isset($_POST['tambah'])){
  ...
  $cek = mysql_query("SELECT * FROM kriteria WHERE kode='$kode'");
  
  if (mysql_num_rows($cek) > 0) {
    echo "<script>window.alert('Kode tidak boleh sama')</script>";
     }else {
      $input = mysql_query("INSERT INTO kriteria VALUES(NULL, '$kode', '$namaKriteria', '$atribut')") or die(mysql_error());
