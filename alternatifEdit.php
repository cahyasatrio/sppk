...
<body>
  ...
  include('koneksi.php');
  $no = $_GET['id'];
  $show = mysql_query("SELECT * FROM alternatif WHERE no='$no'");
...
<center><h1>Tambah Alternatif</h1><br>
 ...
 <label>Kode</label>
                      ...
                      <input name="namaAlternatif" class="form-control" id="ex1" type="text" style="width:400px" value="<?php echo $data['namaAlternatif']; ?>" required><br>
                       <label>Keterangan</label>
                      <input name="keterangan" class="form-control" id="ex1" type="text" style="width:400px" value="<?php echo $data['keterangan']; ?>" required><br>                      
...
if(isset($_POST['tambah'])){
  ...
  $update = mysql_query("UPDATE alternatif SET kode='$kode', namaAlternatif='$namaAlternatif', keterangan='$keterangan', suhu='$suhu', kedalaman='$kedalaman', ukuranKolam='$ukuranKolam', kualitasAir='$kualitasAir', jenisKolam='$jenisKolam', sirkulasiAir='$sirkulasiAir' WHERE no='$no'") or die(mysql_error());
